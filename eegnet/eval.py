...
# Focal loss function directly defined for evaluation
...
def main():
    ...
    print(f"{'='*50}")
    print(f"  Evaluating Model: EEGNet")
    print(f"{'='*50}")
    ...
    val_loader = OriginalLoader(ds=MANIFEST_PATH, transform=None, batch_size=128, shuffle=False, num_workers=2).return_Loader()
