...
==============================
Converts raw EEG ΓåÆ Mel Spectrogram, then feeds it to a CNN-LSTM with
...
# =========================================================
# AUGMENTATION ΓÇö 2D Spectrogram (SpecAugment-style)
# =========================================================
class SpectrogramAugmentation(nn.Module):
    ...
    Techniques:
      1. Frequency Masking  ΓÇö zeros random frequency bands (forces model to
                              not rely on a single frequency range)
      2. Time Masking       ΓÇö zeros random time columns (forces temporal
    ...
    def forward(self, x):
        """x: [B, C, F, T] ΓÇö multi-channel Mel spectrogram"""
...
def mixup_data(x, y, alpha=0.1):
    ...
    alpha=0.1 creates gentle blends (lambda Γëê 0.9ΓÇô1.0).
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        from core.train_helper import get_current_lr, compute_classification_metrics
